...
namespace информпроект {
    ...
    public partial class Database9DataSet : global::System.Data.DataSet {
        ...
        public partial class Таблица1DataTable : global::System.Data.TypedTableBase<Таблица1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public Таблица1Row AddТаблица1Row(string Название_книги, string автор, string Жанр, decimal Цена) {
        ...
        public partial class Таблица1Row : global::System.Data.DataRow {
            ...
            public string Жанр {
                get {
                    try {
                        return ((string)(this[this.tableТаблица1.ЖанрColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Жанр\' в таблице \'Таблица1\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableТаблица1.ЖанрColumn] = value;
                }
            }
            ...
            public bool IsЖанрNull() {
                return this.IsNull(this.tableТаблица1.ЖанрColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetЖанрNull() {
                this[this.tableТаблица1.ЖанрColumn] = global::System.Convert.DBNull;
            }
...
namespace информпроект.Database9DataSetTableAdapters {
    ...
    public partial class Таблица1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Таблица1` WHERE ((`Код` = ?) AND ((? = 1 AND `Название книги` IS NULL) OR (`Название книги` = ?)) AND ((? = 1 AND `автор` IS NULL) OR (`автор` = ?)) AND ((? = 1 AND `Жанр` IS NULL) OR (`Жанр` = ?)) AND ((? = 1 AND `Цена` IS NULL) OR (`Цена` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Таблица1` (`Название книги`, `автор`, `Жанр`, `Цена`) VALUES (?, ?, " +
                "?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Таблица1` SET `Название книги` = ?, `автор` = ?, `Жанр` = ?, `Цена` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `Название книги` IS NULL) OR (`Название книги` = ?)) AND ((? = 1 AND `автор` IS NULL) OR (`автор` = ?)) AND ((? = 1 AND `Жанр` IS NULL) OR (`Жанр` = ?)) AND ((? = 1 AND `Цена` IS NULL) OR (`Цена` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::информпроект.Properties.Settings.Default.Database9ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, [Название книги], автор, Жанр, Цена FROM Таблица1";
        ...
        public virtual int Fill(Database9DataSet.Таблица1DataTable dataTable) {
        ...
        public virtual Database9DataSet.Таблица1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database9DataSet.Таблица1DataTable dataTable = new Database9DataSet.Таблица1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database9DataSet.Таблица1DataTable dataTable) {
        ...
        public virtual int Delete(int Original_Код, string Original_Название_книги, string Original_автор, string Original_Жанр, global::System.Nullable<decimal> Original_Цена) {
        ...
        public virtual int Insert(string Название_книги, string автор, string Жанр, global::System.Nullable<decimal> Цена) {
        ...
        public virtual int Update(string Название_книги, string автор, string Жанр, global::System.Nullable<decimal> Цена, int Original_Код, string Original_Название_книги, string Original_автор, string Original_Жанр, global::System.Nullable<decimal> Original_Цена) {
            if ((Название_книги == null)) {
